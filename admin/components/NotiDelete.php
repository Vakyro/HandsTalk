...
<div id="alertDiv" role="alert" class="anim rounded-xl border border-gray-100 bg-white p-4 w-[34%] mx-auto">
  <div class="flex items-start gap-4">
    ...
    <div class="flex-1">
      <strong class="block font-medium text-gray-900"> Registro eliminado </strong>
      <p class="mt-1 text-sm text-gray-700">
        Los datos del <?php echo $Objeto ; ?> fueron eliminados correctamente 
      </p>
    </div>
