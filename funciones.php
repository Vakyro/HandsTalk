<?php
  ...
  function ObtenerListaFavoritosPorUsuario($IdUsuario) {
    include ("conexionDB.php");
    $query = "SELECT IdFavorito,IdUsuario,IdSena,IdCategoria FROM favoritos WHERE IdUsuario = $IdUsuario";
  ...
  function obtenerDatosFavoritosPorUsuario($IdUsuario) {
    include ("conexionDB.php");
    $query = "SELECT IdFavorito,IdUsuario,IdSena,IdCategoria FROM favoritos WHERE IdUsuario = $IdUsuario";
