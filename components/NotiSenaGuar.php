...
<div id="alertDiv" role="alert" class="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 hidden custom-fade-in-out">
  <div class="flex items-start gap-2 p-2 bg-white border border-gray-100 rounded-xl sm:p-4">
    ...
    <div class="flex-1">
      <strong class="block font-medium text-gray-900 text-xs sm:text-base">Datos Guardados</strong>
      <p class="mt-1 text-xs text-gray-700 sm:text-sm">
        Los datos de la <?php echo $Objeto; ?> fueron guardados correctamente
      </p>
    </div>
